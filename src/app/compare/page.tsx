...
export default async function ComparePage({ searchParams }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-bold mb-2">Compare Drug Side Effects</h1>
      ...
      <div className="flex gap-4 mb-8 flex-wrap">
        <div className="flex-1">
          <label className="block text-xs font-semibold text-slate-500 mb-1">Drug A</label>
          <DrugSearchBar initialValue={slugA ?? ''} />
        </div>
        <div className="flex-1">
          <label className="block text-xs font-semibold text-slate-500 mb-1">Drug B</label>
